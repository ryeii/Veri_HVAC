...
port_angeles_winter_x, port_angeles_winter_y = pd.read_csv(x_files[0])[:20544], pd.read_csv(y_files[0])[:20544]
port_angeles_summer_x, port_angeles_summer_y = pd.read_csv(x_files[0])[20544:], pd.read_csv(y_files[0])[20544:]
pittsburgh_winter_x, pittsburgh_winter_y = pd.read_csv(x_files[1])[:20544], pd.read_csv(y_files[1])[:20544]
pittsburgh_summer_x, pittsburgh_summer_y = pd.read_csv(x_files[1])[20544:], pd.read_csv(y_files[1])[20544:]
tucson_winter_x, tucson_winter_y = pd.read_csv(x_files[2])[:20544], pd.read_csv(y_files[2])[:20544]
tucson_summer_x, tucson_summer_y = pd.read_csv(x_files[2])[20544:], pd.read_csv(y_files[2])[20544:]
new_york_winter_x, new_york_winter_y = pd.read_csv(x_files[3])[:20544], pd.read_csv(y_files[3])[:20544]
